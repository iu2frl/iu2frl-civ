...
# Edit for IC-9700, base file was ic7300.py
...
def main():
    ...
    # Address is 0xA2
    # Add timeout caused boot is slow 
    radio = DeviceFactory.get_repository(radio_address="0xA2", device_type=DeviceType.IC_9700, port="COM10", timeout=10, fake=False)
